...
import { Award, Shield } from "../../components/icons";

export const metadata = {
  title: "About Us | AeroLux Travel",
  description: "An official airline retailer for over a decade, making premium cabins accessible with privately negotiated fares and dedicated experts.",
};
  ...
  return (
    <>
      ...
      <section className="bg-white py-16 sm:py-24">
        <div className="container-x grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <h2 className="section-title">Comfort You Can Afford</h2>
            <p className="mt-5 text-ink/70">
              AeroLux Travel is an official airline retailer offering personalised,
              one-on-one service and exclusive deals on business and first class flights.
              With privately negotiated rates from 70+ major carriers, our dedicated
              travel managers craft itineraries around your preferences.
            </p>
            <p className="mt-4 text-ink/65">
              Unlike online platforms, we put you in direct contact with a live expert who
              does the legwork — unlocking fares reserved for offline sale and standing by
              24/7 from the first quote until you're safely home.
            </p>
          </div>
      ...
      <section className="bg-navy py-16 sm:py-24">
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center text-white">
            ...
            <h2 className="font-serif text-3xl font-bold sm:text-4xl">A Decade of Growth</h2>
          </div>
          <ol className="mx-auto mt-12 max-w-3xl space-y-6">
            {milestones.map((m) => (
              <li key={m.year} className="relative rounded-2xl border border-white/10 bg-white/[0.04] p-6 pl-8">
                ...
                <h3 className="mt-1 font-serif text-xl font-bold text-white">{m.title}</h3>
      ...
      <section className="bg-mist py-16 sm:py-24">
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
            <p className="eyebrow mb-3">Trust & Credibility</p>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {accreditations.map((a) => (
              <div key={a.name} className="rounded-2xl bg-white p-7 shadow-card">
                ...
                <h3 className="mt-4 font-serif text-lg font-bold text-navy">{a.name}</h3>
      ...
      <section className="bg-white py-16 sm:py-24">
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
            <p className="eyebrow mb-3">Meet the Experts</p>
            <h2 className="section-title">Your Travel Managers</h2>
            <p className="mt-4 text-ink/65">
          ...
          <div className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-5">
            {team.map((t) => (
              <div key={t.name} className="text-center">
                ...
                <h3 className="mt-3 font-serif text-lg font-bold text-navy">{t.name}</h3>
                <p className="text-xs uppercase tracking-wider text-ink/55">{t.role}</p>
              </div>
            ))}
          </div>
          <div className="mt-12 text-center">
            <a href="#quote" className="btn-gold">Work With Our Team</a>
          </div>
        </div>
      </section>
    </>
