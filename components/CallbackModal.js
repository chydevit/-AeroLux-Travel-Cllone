  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center overflow-y-auto bg-navy-900/70 p-4 backdrop-blur-sm sm:items-center">
      <div className="relative my-auto grid w-full max-w-3xl overflow-hidden rounded-2xl bg-white shadow-lift sm:grid-cols-2">
        <button onClick={close} aria-label="Close" className="absolute right-4 top-4 z-10 text-ink/40 hover:text-navy">
        ...
        <div className="relative hidden flex-col justify-center overflow-hidden bg-gradient-to-br from-navy-700 to-navy-900 p-8 text-white sm:flex">
          ...
          <p className="mt-6 font-serif text-3xl font-bold leading-tight">We&apos;re here to help, 24/7</p>
        ...
        <div className="p-6 text-center sm:p-8">
          {done ? (
            <div className="py-10">
              ...
              <button onClick={close} className="btn-gold mt-6">Close</button>
            </div>
          ) : (
            <>
              <h3 className="font-serif text-2xl font-bold text-navy">Call to speak 24/7</h3>
              <a
              ...
              <h4 className="font-serif text-xl font-bold text-navy">Request a Free Callback</h4>
              ...
              <p className="mt-4 text-left text-[11px] leading-relaxed text-ink/45">
                *One of our Travel Agents will call you back within the next few minutes. By
                submitting your phone number you agree to be contacted for travel information
                via automated phone and text messages. Your consent to receive such messages
                is not a condition of purchase.{" "}
                <span className="font-semibold text-ink/70">No Spam &amp; 100% Data Safety.</span>
              </p>
            </>
          )}
        </div>
