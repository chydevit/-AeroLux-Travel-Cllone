    ...
    <section id="how" className="relative overflow-hidden bg-navy-800 py-16 sm:py-24">
      ...
      <div className="container-x relative">
        <div className="mx-auto max-w-2xl text-center text-white">
          <p className="eyebrow mb-3">{t("Simple & Transparent")}</p>
          <h2 className="font-serif text-3xl font-bold sm:text-4xl">
            {t("Three Easy Steps to Book")}
          </h2>
          <p className="mt-4 text-white/65">
            {t("No booking engines, no guesswork — just a clear path from idea to e-ticket.")}
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {steps.map((s, i) => (
            <div key={s.n} className="relative text-center">
              ...
              <h3 className="mt-5 font-serif text-xl font-bold text-white">{t(s.title)}</h3>
