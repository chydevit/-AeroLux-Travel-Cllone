    ...
    <section className="bg-white py-16 sm:py-24">
      <div className="container-x max-w-3xl">
        <div className="text-center">
          <p className="eyebrow mb-3">{t("Good to Know")}</p>
          <h2 className="section-title">{t("Frequently Asked Questions")}</h2>
          <p className="mt-4 text-ink/65">
            {t("Premium cabins mean priority boarding, lie-flat seats and elevated service — and they no longer have to mean an unreachable price.")}
          </p>
        </div>
