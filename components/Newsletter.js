        ...
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-navy-700 to-navy-900 p-8 shadow-lift ring-1 ring-white/10 sm:p-12">
          <div className="grid items-center gap-8 lg:grid-cols-2">
            <div className="text-white">
              <p className="eyebrow mb-3">Never Miss a Fare</p>
              <h2 className="font-serif text-3xl font-bold sm:text-4xl">
                Get Price-Drop Alerts &amp; Save up to 77%
              </h2>
              <p className="mt-4 max-w-md text-white/65">
                Join our private list and be first to receive exclusive business and
                first class offers — many available offline only.
              </p>
            </div>
            ...
            {done ? (
              <div className="rounded-2xl bg-white/10 p-8 text-center text-white ring-1 ring-white/15">
                ...
                <h3 className="font-serif text-xl font-bold">You&apos;re on the list!</h3>
                <p className="mt-2 text-sm text-white/65">
                  Watch your inbox — exclusive fares are on the way.
                </p>
              </div>
            ) : (
              <form onSubmit={submit} className="rounded-2xl bg-white p-5 shadow-card">
                ...
                <p className="mt-3 text-[11px] leading-relaxed text-ink/45">
                  By subscribing you agree to receive promotional messages. Your data is
                  stored securely and you can unsubscribe at any time. 100% privacy
                  guaranteed.
                </p>
              </form>
            )}
