...
export default function CallbackButton() {
  ...
  return (
    <a
      ...
      aria-label="Request a free call back"
    >
      ...
      <span className="relative flex flex-col items-center leading-none">
        ...
        <span className="text-[9px] font-bold uppercase tracking-wider text-gold-soft">Online 24/7</span>
        <span className="mt-1 text-[13px] font-extrabold uppercase">
          Free Call
          <br />
          Back
        </span>
